...
public abstract class AbstractHasData<T> extends Composite implements HasData<T>,
  ...
  public static class DefaultKeyboardSelectionHandler<T> implements CellPreviewEvent.Handler<T> {
     ...
     * {@link KeyboardPagingPolicy} is
     * {@link KeyboardPagingPolicy#INCREASE_RANGE}.
     */
   ...
   * {@link #setSelectionModel(SelectionModel, CellPreviewEvent.Handler)}. {@link DefaultSelectionEventManager} provides some default
   ...
   * the {@link CellPreviewEvent.Handler} that
