 ...
 */
class CellBasedWidgetImplTrident extends org.gwtproject.user.cellview.client.CellBasedWidgetImpl {
  ...
  private native void sinkFocusEvents(Element elem) /*-{
    elem.attachEvent('onfocusin',
        @org.gwtproject.user.cellview.client.CellBasedWidgetImplTrident::dispatchFocusEvent);
