...
/**
 * A {@link SuggestOracle} can be used to create
...
public abstract class SuggestOracle { 
  ...
  public interface Callback {
     ...
     * {@link SuggestOracle} in response to a
     * {@link Request}.
     * 
   ...
   * {@link SuggestOracle}. Each suggestion has a
   ...
   * {@link org.gwtproject.event.logical.shared.SelectionHandler} to the SuggestBox
   ...
   * {@link org.gwtproject.event.logical.shared.SelectionEvent} object, and downcast
  ...
  /**
   * Constructor for {@link SuggestOracle}.
   */
   ...
   * {@link Callback#onSuggestionsReady(Request, Response)}
   * .
   * </p>
   * 
   * @param request the request
