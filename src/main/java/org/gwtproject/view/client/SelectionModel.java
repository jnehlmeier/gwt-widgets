 ...
 */
public interface SelectionModel<T> extends HasSelectionChangedHandlers, org.gwtproject.view.client.ProvidesKey<T> {
  ...
  public abstract class AbstractSelectionModel<T> implements SelectionModel<T> {
    ...
    public HandlerRegistration addSelectionChangeHandler(
      ...
      return handlerManager.addHandler(org.gwtproject.view.client.SelectionChangeEvent.getType(), handler);
    }
    ...
    /**
     * Returns a {@link org.gwtproject.view.client.ProvidesKey} instance that simply returns the input data
     * item.
     *
    ...
    /**
     * Fire a {@link org.gwtproject.view.client.SelectionChangeEvent}.  Multiple firings may be coalesced.
     */
    ...
    /**
     * Schedules a {@link org.gwtproject.view.client.SelectionChangeEvent} to fire at the
   ...
   */
  @Override
  HandlerRegistration addSelectionChangeHandler(org.gwtproject.view.client.SelectionChangeEvent.Handler handler);
   ...
   * {@link org.gwtproject.view.client.SelectionChangeEvent} if the selection has
