 ...
 */
public interface HasData<T> extends HasRows, org.gwtproject.view.client.HasCellPreviewHandlers<T> {
   ...
   * </p>
   * 
   * @param range the new {@link org.gwtproject.view.client.Range}
   * @param forceRangeChangeEvent true to fire a {@link RangeChangeEvent} even
   *          if the {@link org.gwtproject.view.client.Range} doesn't change
   */
  void setVisibleRangeAndClearData(org.gwtproject.view.client.Range range, boolean forceRangeChangeEvent);
}
