 ...
 */
public class OrderedMultiSelectionModel<T> extends org.gwtproject.view.client.MultiSelectionModel<T> {
  /**
   ...
   */
  public OrderedMultiSelectionModel(org.gwtproject.view.client.ProvidesKey<T> keyProvider) {
