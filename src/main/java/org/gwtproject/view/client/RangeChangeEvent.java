...
public class RangeChangeEvent extends Event<RangeChangeEvent.Handler> {
  ...
  private final org.gwtproject.view.client.Range range;
   ...
   * @param range the new range
   */
  protected RangeChangeEvent(org.gwtproject.view.client.Range range) {
    this.range = range;
  }
   ...
   */
  public org.gwtproject.view.client.Range getNewRange() {
    return range;
  }
