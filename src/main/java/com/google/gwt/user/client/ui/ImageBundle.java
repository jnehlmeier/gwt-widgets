 ...
 * {@link AbstractImagePrototype prototype} from
 ...
 * of
 * {@link AbstractImagePrototype AbstractImagePrototype}.
 ...
 * @see AbstractImagePrototype
 * @see Image#Image(String, int, int, int, int)
 * @see Image#setVisibleRect(int, int, int, int)
 * @see Image#setUrlAndVisibleRect(String, int,
 *      int, int, int)
