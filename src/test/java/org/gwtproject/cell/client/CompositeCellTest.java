...
/**
 * Tests for {@link org.gwtproject.cell.client.CompositeCell}.
 */
public class CompositeCellTest extends CellTestBase<String> {
  ...
  public void testDependsOnSelectionTrue() {
    ...
    List<org.gwtproject.cell.client.HasCell<String, ?>> cells = createHasCells(3);
    final MockCell<String> mock = new MockCell<String>(true, null);
    addCell(mock, cells);
    org.gwtproject.cell.client.CompositeCell<String> cell = new org.gwtproject.cell.client.CompositeCell<String>(cells);
  ...
  public void testOnBrowserEventCell() {
    ...
    List<org.gwtproject.cell.client.HasCell<String, ?>> cells = createHasCells(2);
    MockCell<String> innerCell = new MockCell<String>(false, "fromCell2", "click");
    addCell(innerCell, cells);
    final org.gwtproject.cell.client.CompositeCell<String> cell = new org.gwtproject.cell.client.CompositeCell<String>(cells);
  ...
  @Override
  protected org.gwtproject.cell.client.CompositeCell<String> createCell() {
  ...
  /**
   * Add a cell to a {@link org.gwtproject.cell.client.HasCell} list.
   */
  private void addCell(final org.gwtproject.cell.client.Cell<String> cell, List<org.gwtproject.cell.client.HasCell<String, ?>> cells) {
    cells.add(new org.gwtproject.cell.client.HasCell<String, String>() {
      @Override
      public org.gwtproject.cell.client.Cell<String> getCell() {
        return cell;
      }

      @Override
      public org.gwtproject.cell.client.FieldUpdater<String, String> getFieldUpdater() {
        return null;
      }
  ...
  /**
   * Create an array of {@link org.gwtproject.cell.client.HasCell}.
   *
   * @param count the number of cells to create
   * @return the list of cells
   */
  private List<org.gwtproject.cell.client.HasCell<String, ?>> createHasCells(int count) {
    List<org.gwtproject.cell.client.HasCell<String, ?>> cells = new ArrayList<org.gwtproject.cell.client.HasCell<String, ?>>();
