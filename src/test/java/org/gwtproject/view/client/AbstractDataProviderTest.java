...
public class AbstractDataProviderTest extends GWTTestCase {
  ...
  public void testGetRanges() {
    org.gwtproject.view.client.AbstractDataProvider<String> provider = createDataProvider();

    // No ranges.
    {
      org.gwtproject.view.client.Range[] ranges = provider.getRanges();
    ...
    // One range.
    {
      ...
      assertEquals(new org.gwtproject.view.client.Range(0, 10), ranges[0]);
    }
    ...
    // Multiple ranges.
    {
      ...
      assertTrue(ranges.contains(new org.gwtproject.view.client.Range(0, 10)));
      assertTrue(ranges.contains(new org.gwtproject.view.client.Range(3, 10)));
      assertTrue(ranges.contains(new org.gwtproject.view.client.Range(30, 35)));
    }
  }
  ...
  public void testKeyProvider() {
    ...
    org.gwtproject.view.client.AbstractDataProvider<String> provider = createDataProvider(null);
  ...
  public void testUpdateRowData() {
    ...
    // Data equal to range.
    {
      ...
      assertEquals(new org.gwtproject.view.client.Range(10, 5), display.getLastRowDataRange());
    ...
    // Data contained within range.
    {
      ...
      assertEquals(values, display.getLastRowData());
      assertEquals(new org.gwtproject.view.client.Range(12, 2), display.getLastRowDataRange());
      display.clearLastRowDataAndRange();
    }
    ...
    // Empty data list starting at page start.
    {
      ...
      provider.updateRowData(10, values);
      assertEquals(values, display.getLastRowData());
      assertEquals(new org.gwtproject.view.client.Range(10, 0), display.getLastRowDataRange());
      display.clearLastRowDataAndRange();
    }
    ...
    // Data overlaps start of range.
    {
      ...
      assertEquals(new org.gwtproject.view.client.Range(10, 2), display.getLastRowDataRange());
      display.clearLastRowDataAndRange();
    }
    ...
    // Data overlaps end of range.
    {
      ...
      assertEquals(new org.gwtproject.view.client.Range(13, 2), display.getLastRowDataRange());
      display.clearLastRowDataAndRange();
    }
  }
  ...
  public void testUpdateRowDataMultipleDisplays() {
    ...
    assertEquals(new org.gwtproject.view.client.Range(10, 5), display0.getLastRowDataRange());
   ...
   */
  protected org.gwtproject.view.client.AbstractDataProvider<String> createDataProvider() {
